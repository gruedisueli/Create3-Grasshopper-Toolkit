...
moves = [
    SequenceStep([
        MessageDriveStraight("Dolores", 0.8609, 0.0750)]),
    SequenceStep([
        MessageDriveArc("Dolores", -3.1416, 0.1696, 0.0750, True)]),
    SequenceStep([
        MessageDriveStraight("Dolores", 0.8609, 0.0750)]),
    SequenceStep([
        MessagePlaySong("Dolores", [220,440,220], [1000000000,2000000000,1000000000])]),
    SequenceStep([
        MessageDriveArc("Dolores", -3.0193, 0.1696, 0.0750, True)]),
]
